...
const eMail1 = async (eMail) => {
  let mensaHTM = `
      ...
      <div style="background-color: #e3e3e3; margin-top: 0px; padding: 20px 0px 5px 0px; text-align: center;">
        ...
        <div style="background-color: rgb(2, 27, 80); color: #9eaf08; padding: 5px 0px 0px 0px; width: 100%; text-align: center;">
          ...
          <p>Comunicate con nosotros por los siguientes canales:<br>
            ...
            <a href="https://www.instagram.com/rent_car2023/"style="color: #9faa09;"><img src="" style="width: 30px; height: 30px;"/></a>
            <a href="https://twitter.com/Rent_Car2023"style="color: #9faa09;"><img src="https://cdn.icon-icons.com/icons2/2864/PNG/512/twitter_logo_icon_181735.png" style="width: 30px; height: 30px;"/></a>
          </p>
    ...
    `;
  let mensaje = {
    from: '"CarMania" <@gmail.com>', // sender address
