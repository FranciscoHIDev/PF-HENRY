    ...
    <>
      ...
      <div className={Style.container_2}>
        ...
        <div className={Style.info}>
          <p>
            We provide tailor-made approach to fit your unique requirement and
            considerations. We offer full support and service on all stages of
            purchase and financing a car of your dream.
          </p>
          <Link to="/home">
      ...
      <div className={Style.container_3}>
        ...
        <div className={Style.col2}>
          ...
          <p>
            Our cars stand for automotive extravagance - more power, more
            comfort and more expertise. An exclusive selection in the sports
            cars and luxury segment as well as the appropriate service focus for
            correspondingly high demands. In addition to prestigious and
            traditional brands such as Ferrari, Lamborghini, Bentley, Porsche,
            Land Rover and Mercedes, we provide classics designs to limited
            model variants. High-class tuning and procurement of rare model
      ...
      <div className="text-center p-10 bg-slate-50">
        <h2 className="font-bold text-3xl tracking-wide text-cyan-800">
          Meet our team members
        </h2>
        <p className="w-3/5 mx-auto mt-4 mb-7 tracking-wider">
          This project would not have been possible without these 6 people, who
          always pursued the idea of making something out of the ordinary.
        </p>
        <div className="flex flex-wrap justify-center gap-10">
          <div className="w-80 shadow-md bg-white p-5 rounded-2xl">
            ...
            <div className="flex mt-2">
              <a
                className="m-3 ml-0"
                href="https://github.com/RamiroE1"
                target="_blank"
              >
                <div>
                  <BsGithub></BsGithub>
              ...
              <a
                className="m-3"
                href="https://www.linkedin.com/in/ramiro-espinosa-gallo-438064105"
                target="_blank"
              >
                <div>
          ...
          <div className="w-80 shadow-md bg-white p-5 rounded-2xl">
            ...
            <p className="text-left tracking-wider">
              Highly motivated researcher of the web stack.
            </p>
            <div className="flex mt-2">
              <a
                className="m-3 ml-0"
          ...
          <div className="w-80 shadow-md bg-white p-5 rounded-2xl">
            ...
            <p className="text-left tracking-wider">
              Always looking forward to debugging different files.
            </p>
            <div className="flex mt-2">
              <a
                className="m-3 ml-0"
                href="https://github.com/javimt"
                target="_blank"
              >
                <div>
                  <BsGithub></BsGithub>
              ...
              <a
                className="m-3"
                href="https://www.linkedin.com/in/javier-garcia-plata-033349246/"
                target="_blank"
              >
                <div>
                  <BsLinkedin></BsLinkedin>
          ...
          <div className="w-80 shadow-md bg-white p-5 rounded-2xl">
            ...
            <p className="text-left tracking-wider">
              Investigating new ways of developing apps.
            </p>
            <div className="flex mt-2">
              <a
                className="m-3 ml-0"
                href="https://github.com/sibas1"
                target="_blank"
              >
                <div>
                  <BsGithub></BsGithub>
              ...
              <a
                className="m-3"
                href="https://www.linkedin.com/in/cesar-lopez-a7226625a/"
                target="_blank"
              >
                <div>
                  <BsLinkedin></BsLinkedin>
          ...
          <div className="w-80 shadow-md bg-white p-5 rounded-2xl">
            ...
            <p className="text-left tracking-wider">
              Making projects to revolutionize the industry.
            </p>
            <div className="flex mt-2">
              <a
                className="m-3 ml-0"
                href="https://github.com/mago0oxx"
                target="_blank"
              >
                <div>
                  <BsGithub></BsGithub>
              ...
              <a
                className="m-3"
                href="https://www.linkedin.com/in/daniel-augusto-quijada-higgins-92b9a312b/"
                target="_blank"
              >
                <div>
                  <BsLinkedin></BsLinkedin>
          ...
          <div className="w-80 shadow-md bg-white p-5 rounded-2xl">
            ...
            <p className="text-left tracking-wider">
              Trying to make different kind of outstanding designs.
            </p>
            <div className="flex mt-2">
              <a
                className="m-3 ml-0"
                href="https://github.com/PedroSaraviaQ"
                target="_blank"
              >
                <div>
                  <BsGithub></BsGithub>
              ...
              <a
                className="m-3"
                href="https://www.linkedin.com/in/pedrosaravia/"
                target="_blank"
              >
                <div>
                  <BsLinkedin></BsLinkedin>
